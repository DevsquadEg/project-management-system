...
import { EMAIL_VALIDATION } from "../../../service/validators"
  ...
  return (
    <main className="rounded-2 py-2 px-4" role="main">
      <section aria-labelledby="verify-heading" className="text mt-3">
        ...
        <h1 id="verify-heading" className="h4 fw-bold" style={{ color: "#EF9B28" }}>
          Verify Account
        </h1>
      </section>

      <form className="row mt-2 py-3" onSubmit={handleSubmit(verificationAccount)} noValidate>
        <div className="col-md-8">
          ...
          <div className="mb-3">
            ...
            />
            {errors.email && (
              <p id="email-error" className="text-white" style={{ fontSize: 12 }} role="alert">
          ...
          <div className="mb-3">
            ...
            />
            {errors.code && (
              <p id="otp-error" className="text-white" style={{ fontSize: 12 }} role="alert">
                {errors.code.message}
              </p>
            )}
          </div>
        ...
        <button disabled={isSubmitting} className="btn custom-btn btn-lg mt-3">
