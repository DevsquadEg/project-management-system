...
export default function Dashboard() {
  ...
  <div className="row gy-4">
    ...
    <div className="col-md-6">
      <div className={`p-4 rounded-4 shadow-sm ${darkMode ? "bg-dark" : "bg-white"} card-bg`}>
        ...
        <div className="d-flex gap-3 flex-wrap">
          ...
          <StatCard
            ...
            label="Completed"
            value={allTasks.filter((t: any) => t.status === "Done").length}
      ...
      <div className="col-md-6">
        <div className={`p-4 rounded-4 shadow-sm ${darkMode ? "bg-dark" : "bg-white"} card-bg`}>
          <div className="border-start border-4 ps-3 mb-3 border-primary-theme">
            ...
            <small className="text-muted-theme">
              users are the key to any project, bringing skills and expertise to
            </small>
          </div>
